const songs = [
  {
    ...
    lyrics: [
      ...
      { start: 62.0, end: 65.0, text: "はじまりの合図鳴らせば" },
      ...
      { start: 68.8, end: 69.3, text: "la", effect: "pop"  },
      { start: 69.8, end: 70.3, text: "la-" , effect: "pop" },
      { start: 70.3, end: 71.7, text: "la-!!" , effect: "pop" },
